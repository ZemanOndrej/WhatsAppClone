...
public class PhoneNumberNormalizer {
    ...
    public static String normalizePhoneNumber(String phone, Context context) {
        phone = phone.replace(" ", "");
        phone = phone.replace("-", "");
        phone = phone.replace("(", "");
        phone = phone.replace(")", "");
        if (!String.valueOf(phone.charAt(0)).equals("+")) {
            phone = getCountryISO(context) + phone;
        }
        return phone;
    }
    ...
    private static String getCountryISO(Context context) {
        ...
        if (tm.getNetworkCountryIso() != null && tm.getNetworkCountryIso().equals("")) {
            iso = tm.getNetworkCountryIso();
        }
        return PhoneNumberNormalizer.getPhone(iso);
    }
